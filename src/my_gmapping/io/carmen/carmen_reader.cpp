...
namespace Sensor = MyGMapping::Sensor;
    ...
    std::vector<Sensor::SensorDataPtr>& sensorData)
{
    switch (dataType) {
        ...
        case DataType::RawLaser: {
            /* Read scan data (new format)
                * (For RAWLASER1, RAWLASER2, RAWLASER3, RAWLASER4) */
    ...
    const ParamMapType& /* paramMap */)
{
    ...
    /* Pose of robot and laser scanner in base frame */
