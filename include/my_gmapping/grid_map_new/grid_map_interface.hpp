...
#ifndef MY_GMAPPING_GRID_MAP_NEW_GRID_MAP_INTERFACE_HPP
#define MY_GMAPPING_GRID_MAP_NEW_GRID_MAP_INTERFACE_HPP

#include <cstdint>

#include "my_gmapping/grid_map_new/grid_map_geometry.hpp"
#include "my_gmapping/bounding_box.hpp"
...
public:
    ...
    virtual void CopyValuesU8x4(std::uint32_t* buffer) const = 0;
    /* Copy the internal values as std::uint8_t to the buffer
     * and ensure the 4-byte aligned accesses */
    virtual void CopyValuesU8x4(std::uint32_t* buffer,
                                const BoundingBox<int>& boundingBox) const = 0;
...
#endif /* MY_GMAPPING_GRID_MAP_NEW_GRID_MAP_INTERFACE_HPP */
